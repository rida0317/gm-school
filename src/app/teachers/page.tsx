        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {loading ? (
            ...
            filteredTeachers.map((t) => {
              const isVacataire = t.contract_type === 'VACATAIRE';
              const availabilityCount = Array.isArray(t.availability) ? t.availability.length : 0;
              const teacherLevels = Array.isArray(t.teaching_levels) ? t.teaching_levels : [];
                      ...
                      <div className="flex items-start gap-2 pt-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {teacherLevels.length === 0 ? (
                            <span className="text-[10px] text-slate-400 italic">Tous niveaux</span>
                          ) : (
                      ...
                      <div className="pt-2 mt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-[11px]">
                        ...
                        {isVacataire ? (
                          <strong className="text-amber-600 dark:text-amber-400 font-bold">
                            {availabilityCount} séances ({availabilityCount}h / semaine)
                          </strong>
                        ) : (
                          <strong className="text-emerald-600 dark:text-emerald-400 font-bold">
                            Toute la semaine (Plein Temps)
                          </strong>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="pt-3 mt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        title="Modifier l'enseignant, ses niveaux et ses disponibilités"
